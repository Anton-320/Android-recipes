...
### Работа отображения списка рецептов

1. Корректное отображение всех элементов списка
2. Просмотр информации об элементе списка

### Работа добавления и редактирования информации

1. Корректное добавление данных рецепта
2. Корректное добавление ингредиентов в рецепт
3. Корректное редактирование данных рецептов

### Работа удаления информации

1. Корректное удаление рецепта
2. Корректное удаление ингредиента
...
Данный тестовый план позволяет проверить основной функционал приложения "Книга рецептов". Успешное прохождение всех тестов не гарантирует полной работоспособности на всех устройствах и версиях Android, однако позволяет утверждать о корректной работе основных функций приложения. Тестирование должно проводиться регулярно при внесении существенных изменений в код проекта.
